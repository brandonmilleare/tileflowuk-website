---
title: "Sigma vs RUBI Tile Cutters: Which to Buy in 2026 (Pro Verdict)"
excerpt: "After 15 years using both on UK jobs, here's the verdict — Sigma wins on porcelain and rigidity, RUBI wins on price. Full head-to-head with current prices."
date: "2026-05-06"
readTime: "9 min"
category: "Comparison"
author: "Brandon, TileFlow UK · 15 years in the trade"
tags: ["Sigma vs RUBI", "Sigma tile cutter", "RUBI tile cutter", "best tile cutter UK", "tile cutter comparison", "professional tiling tools"]
faqs:
  - q: "Is Sigma better than RUBI for porcelain tiles?"
    a: "Yes — Sigma's heavier frame and titanium scoring wheel give a cleaner score on dense porcelain, especially over 8mm thick. RUBI handles thinner ceramic well but can flex on hard porcelain, leading to chipped breaks. For full-time porcelain work, Sigma is the better long-term buy."
  - q: "What's the cheapest decent tile cutter in 2026?"
    a: "The RUBI Slim Cutter G2 sits around £85–£110 and is the cheapest cutter I'd put in front of a professional. Below that price point you're looking at flex-frame cutters that gouge the glaze instead of scoring it — false economy."
  - q: "How long does a Sigma scoring wheel last?"
    a: "Roughly 3,000–5,000 cuts in mixed ceramic and porcelain before the score starts looking ragged. Replacements are around £15. Keep two on the van — wheels are the consumable, the cutter itself lasts decades."
  - q: "Can a RUBI Slim cutter cut large format tiles?"
    a: "Up to about 60cm cleanly. Beyond that the bed length runs out and you lose alignment. For 90cm+ tiles you need a Sigma 4DN, RUBI TR-Magnet, or a wet saw — manual scoring stops being reliable past that size."
  - q: "Sigma vs RUBI for daily site use — which lasts longer?"
    a: "Sigma. Heavier construction, replaceable parts (handle, breaker bar, wheel), and the swivel base resists getting knocked out of square. RUBI cutters last well in a workshop but feel lighter under daily van life."
  - q: "Are Sigma cutters made in Italy?"
    a: "Yes — Sigma is manufactured in Verona, Italy, and has been since 1953. RUBI is Spanish, made in Gavà near Barcelona. Both are family-owned trade brands; neither has moved manufacturing offshore, which is unusual for tools at this price point."
---
...
If you're kitting yourself out from scratch on a tight budget, the RUBI sits in our [budget tiling tools kit for under £310](/best-of/best-budget-tiling-tools-uk) — a sensible first cutter that won't embarrass you on a one-off bathroom.
...
For a deeper look at sizing — manual vs electric, 70cm vs 125cm — see [how to choose the right tile cutter for every job](/blog/how-to-choose-tile-cutter). For 600mm+ tiles specifically, the [best tools for large format tiles guide](/best-of/best-tools-large-format-tiles) covers the full kit you'll need alongside the cutter, and once cuts pass 95cm you're into wet-saw territory — the [best wet saw for tiling UK round-up](/best-of/best-wet-saw-for-tiling) walks through the saws I'd put in front of a paying customer.

---

## The Specific Models I'd Buy Today

**Sigma 4BU 70cm** — [View on Amazon](https://www.amazon.co.uk/dp/B0BSXR5JNM?tag=tileflowuk-21)
...
**Sigma 4DN 95cm** — [View on Amazon](https://www.amazon.co.uk/dp/B0BSXQG3WQ?tag=tileflowuk-21)
...
**RUBI Slim G2** — [View on Amazon](https://www.amazon.co.uk/dp/B0CQK55C9X?tag=tileflowuk-21)
